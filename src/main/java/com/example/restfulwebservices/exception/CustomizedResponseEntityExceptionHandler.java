...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        // Construye un mensaje de error que incluye todos los campos fallidos.
        StringBuilder errorMessage = new StringBuilder("Validation Failed. Total Errors: " + ex.getErrorCount() + ". Errors: [");
